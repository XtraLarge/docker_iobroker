...
RUN apt-get update && apt-get install -y build-essential python apt-utils curl avahi-daemon git libpcap-dev libavahi-compat-libdnssd-dev libudev-dev libpam0g-dev libfontconfig gnupg2 locales procps libudev-dev unzip sudo wget
